...
class PM25:
    def __init__(self, sensor_ip, mqtt_server, topic_pub, topic_sub):
    ...
    def sub_cb(self, topic, msg):
        if topic == b'server' and len(msg) > 0:
            print("hello from Orangepi", msg)
        if topic == b'server' and msg == b'true':
            print("ture from Orangepi")
...
def start(sensor_ip, mqtt_server, topic_pub, topic_sub):
    pm25 = PM25(sensor_ip, mqtt_server, topic_pub, topic_sub)
